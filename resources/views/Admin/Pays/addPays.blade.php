    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title fw-bold">Ajouter un pays</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form action="{{ route('Gestion+Country.store') }}" data-toggle="validator" role="form"
                            ...
                            <div class="col-sm">
                                <div class="form-group">
                                    ...
                                    <input type="file" id="flags" class="form-control" value=""
                                        name="flags" style="height:43px;" required />
                                </div>
                            </div>
                        </div>
                        <div class="row ">
